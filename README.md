...
<img src='./src/assets/images/printProjeto.png' alt='Print do Projeto' />
...
```bash
git clone https://github.com/code-front-braga/PR-Counter.git
```
...
Isso abrirá o projeto no seu navegador padrão. Ou se quiser ver somente o funcional, eu hospedei o projeto no GitHub Pages: [Counter](https://code-front-braga.github.io/PR-Counter/)
...
- Configuração de Passos: Permitir que o usuário defina o valor pelo qual o número é incrementado ou decrementado, ao invés de apenas aumentar ou diminuir em 1.
